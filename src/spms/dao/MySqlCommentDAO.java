...
public class MySqlCommentDAO implements CommentDAO{
	...
	@Override
	public int insert (Comment comment, Customer customer, int no) throws Exception {
		Connection connection = null;
		PreparedStatement stmt = null;
		
		String sqlInsert = "INSERT INTO COMMENT (ID, STORE_NUM, CONTENTS )" +
									   "VALUES(?, "+no+", ?)";
	...
	public int delete(int no) throws Exception {
		...
		String sqlDelete = "DELETE FROM COMMENT WHERE STORE_NUM=" + no;
