...
<body class="center">
            ...
            <div class="input-form-backgroud row">
                <div class="input-form col-md-12 mx-auto" style="margin-bottom: 80px;">
                    <div class="row" style="margin-bottom: 15px;">
                        ...
                        <input type="text" id="store_name" name="store_name" value="${store.store_name }">
                    </div>
                    <div class="row">
                        <label for="store_address">
                        <h5 class="mb-3" style="color: rgb(160, 28, 85);"><strong>가게주소</strong></h5>
                        </label>
                        <input type="text" id="store_address" name="store_address" value="${store.store_address }">
                    </div>
    ...
    <!-- 카카오 맵에서 주소와 위도 찍어올 수 있도록 만들어 보기-->
        ...
        <button style="font-size: 15px;" id="red" class="btn btn-primary btn-lg btn-block " type="submit" value="저장"">수정</button>
        <button style="font-size: 15px;" id="red" class="btn btn-primary btn-lg btn-block " type="button" value="삭제" onclick="location.href='delete.do?store_num=${store.store_num}'">삭제</button>
