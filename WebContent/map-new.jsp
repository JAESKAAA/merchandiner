  ...
  <body>
          ...
          <ul id="placeList">
            ...
            <div class="list-item">
              <div class="list-overlay shadow" id="box4">
                ...
                <div class="place-name">정돈</div>
                <div class="place-address">
                  서울특별시 강남구 역삼동 강남대로110길 26 1층
                </div>
                <div class="theme-name">#장인의손길 #두툼한돈까스</div>
              </div>
            </div>
            <div class="list-item">
              <div class="list-overlay shadow" id="box5">
                ...
                <div class="place-name">딘타이펑</div>
                <div class="place-address">
                  서울특별시 서초구 서초4동 서초대로73길 12
                </div>
                <div class="theme-name">#샤오룽바오 #대만 음식</div>
              </div>
            </div>
            <div class="list-item">
              <div class="list-overlay shadow" id="box6">
                <div class="read-more">
                  <a>
                    <i class="fas fa-expand-alt"></i>
                  </a>
                </div>
                <div class="place-name">호랑이식당 본점</div>
                <div class="place-address">
                  서울특별시 강남구 역삼동 봉은사로4길 20
                </div>
                <div class="theme-name">#아시아레스토랑 #커플맛집</div>
              </div>
            </div>
          </ul>
        </div>
    ...
    <script>
      ...
      var positions = [
        ...
        {
          title: "정돈",
          latlng: new kakao.maps.LatLng(37.5035933, 127.026942),
        },
        {
          title: "딘타이펑",
          latlng: new kakao.maps.LatLng(37.498575, 127.025832),
        },
        {
          title: "호랑이식당 본점",
          latlng: new kakao.maps.LatLng(37.5034673, 127.02632),
        },
      ];
