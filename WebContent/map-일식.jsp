  ...
  <body>
          ...
          <ul id="placeList">
            <div class="list-item">
              <div class="list-overlay shadow" id="box0">
                ...
                <div class="place-name">어부일식O</div>
                <div class="place-address">서울특별시 서초구 서초동 1623-3</div>
                <div class="theme-name">#조용한 #가성비</div>
              </div>
            </div>
            <div class="list-item">
              <div class="list-overlay shadow" id="box1">
                ...
                <div class="place-name">미유끼</div>
                <div class="place-address">
                  서울특별시 서초구 서초3동 1540-11
                </div>
                <div class="theme-name">#상견례장소 #쫄깃쫄깃</div>
              </div>
            </div>
            <div class="list-item">
              <div class="list-overlay shadow" id="box2">
                ...
                <div class="place-name">태평양일식본관</div>
                <div class="place-address">
                  서울특별시 서초구 서초4동 1692-6
                </div>
                <div class="theme-name">#독립공간 #30년</div>
              </div>
            </div>
            <div class="list-item">
              <div class="list-overlay shadow" id="box3">
                ...
                <div class="place-name">미타니야 (교대점)</div>
                <div class="place-address">
                  서울특별시 서초구 서초4동 서초중앙로24길 27
                </div>
                <div class="theme-name">#교토음식전문 #돈까스 #사시미</div>
              </div>
            </div>
            <div class="list-item">
              <div class="list-overlay shadow">
                ...
                <div class="place-name">묵호일식</div>
                <div class="place-address">
                  서울특별시 강남구 논현2동 선릉로129길 3-6
                </div>
                <div class="theme-name">#사시미 #참치회</div>
              </div>
            </div>
          </ul>
        </div>
    ...
    <script>
      var mapContainer = document.getElementById("map"), // 지도를 표시할 div
        mapOption = {
          center: new kakao.maps.LatLng(37.48872, 127.015963), // 지도의 중심좌표
          level: 3, // 지도의 확대 레벨
        };
      ...
      var positions = [
        {
          title: "어부일식",
          latlng: new kakao.maps.LatLng(37.48872, 127.015963),
        },
        {
          title: "미유끼",
          latlng: new kakao.maps.LatLng(37.491032, 127.00808),
        },
        {
          title: "태평양일식본관",
          latlng: new kakao.maps.LatLng(37.496384, 127.015295),
        },
        {
          title: "미타니야 (교대점)",
          latlng: new kakao.maps.LatLng(37.496997, 127.01649),
        },
        {
          title: "묵호일식",
          latlng: new kakao.maps.LatLng(37.517337, 127.04087),
        },
      ];
