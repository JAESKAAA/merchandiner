  ...
  <body>
          ...
          <ul id="placeList">
            <div class="list-item">
              <div class="list-overlay shadow" id="box0">
                ...
                <div class="place-name">노티드</div>
                <div class="place-address">
                  서울 서초구 방배로32길 30-9 101호
                </div>
                <div class="theme-name">#도넛맛집 #줄서야되요</div>
              </div>
            </div>
            <div class="list-item">
              <div class="list-overlay shadow" id="box1">
                ...
                <div class="place-name">오리에</div>
                <div class="place-address">서울 서초구 서초대로32길 8</div>
                <div class="theme-name">#브런치맛집 #스프맛집</div>
              </div>
            </div>
            <div class="list-item">
              <div class="list-overlay shadow" id="box2">
                ...
                <div class="place-name">메종엠오</div>
                <div class="place-address">
                  서울 서초구 방배로26길 22 1층 코너
                </div>
                <div class="theme-name">#호텔베이커리 #휘낭시에</div>
              </div>
            </div>
            <div class="list-item">
              <div class="list-overlay shadow" id="box3">
                ...
                <div class="place-name">밤부 베이커리</div>
                <div class="place-address">서울 서초구 동광로 77</div>
                <div class="theme-name">#크로와상</div>
              </div>
            </div>
            <div class="list-item">
              <div class="list-overlay shadow">
                ...
                <div class="place-name">매뉴팩트커피</div>
                <div class="place-address">서울 서초구 서초대로27길 15</div>
                <div class="theme-name">#커피맛집 #자리없어요</div>
              </div>
            </div>
          </ul>
        </div>
    ...
    <script>
      var mapContainer = document.getElementById("map"), // 지도를 표시할 div
        mapOption = {
          center: new kakao.maps.LatLng(37.4914143, 126.993388), // 지도의 중심좌표
          level: 3, // 지도의 확대 레벨
        };
      ...
      var positions = [
        {
          title: "노티드",
          latlng: new kakao.maps.LatLng(37.4914143, 126.993388),
        },
        {
          title: "오리에",
          latlng: new kakao.maps.LatLng(37.488306, 126.996928),
        },
        {
          title: "메종엠오",
          latlng: new kakao.maps.LatLng(37.4892429, 126.993976),
        },
        {
          title: "밤부",
          latlng: new kakao.maps.LatLng(37.4934053, 126.990798),
        },
        {
          title: "매뉴팩트커피 ",
          latlng: new kakao.maps.LatLng(37.4888015, 126.994474),
        },
      ];
