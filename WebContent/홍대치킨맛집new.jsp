  ...
  <body>
          ...
          <ul id="placeList">
            <div class="list-item">
              <div class="list-overlay shadow" id="box0">
                ...
                <div class="place-name">철인7호 홍대점</div>
                <div class="place-address">양화로 6길 99-3</div>
                <div class="theme-name">치킨앤카레군</div>
              </div>
            </div>
            <div class="list-item">
              <div class="list-overlay shadow" id="box1">
                ...
                <div class="place-name">치킨앤카레군</div>
                <div class="place-address">
                  서울특별시 강남구 강남대로94길 10
                </div>
                <div class="theme-name">#크리미양파 #소스치킨맛집</div>
              </div>
            </div>
            <div class="list-item">
              <div class="list-overlay shadow" id="box2">
                ...
                <div class="place-name">후치오스</div>
                <div class="place-address">
                  서울특별시 마포구 서교동 와우산로19길 26
                </div>
            ...
            <div class="list-item">
              <div class="list-overlay shadow" id="box3">
                ...
                <div class="place-name">깐부치킨</div>
                <div class="place-address">
                  서울특별시 마포구 동교동 동교로 191
                </div>
                <div class="theme-name">#화제의그집 #오징어게임</div>
              </div>
            </div>
            <div class="list-item">
              <div class="list-overlay shadow" id="box4">
                ...
                <div class="place-name">치킨인더치킨</div>
                <div class="place-address">
                  서울특별시 마포구 서교동 와우산로29길 4-42
                </div>
                <div class="theme-name">#누구나다아는 #동네맛집</div>
              </div>
            </div>
            <div class="list-item">
              <div class="list-overlay shadow" id="box5">
                ...
                <div class="place-name">노랑통닭 홍대점</div>
                <div class="place-address">
    ...
    <script>
      var mapContainer = document.getElementById("map"), // 지도를 표시할 div
        mapOption = {
          center: new kakao.maps.LatLng(37.5485276, 126.919759), // 지도의 중심좌표
          level: 3, // 지도의 확대 레벨
        };
      ...
      var positions = [
        {
          title: "철인7호 홍대점",
          latlng: new kakao.maps.LatLng(37.5485276, 126.919759),
        },
        {
          title: "치킨앤카레군",
          latlng: new kakao.maps.LatLng(37.559136, 126.925338),
        },
        {
          title: "후치오스",
          latlng: new kakao.maps.LatLng(37.5513851, 126.921736),
        },
        {
          title: "깐부치킨",
          latlng: new kakao.maps.LatLng(37.5575844, 126.922397),
        },
        {
          title: "치킨인더치킨",
          latlng: new kakao.maps.LatLng(37.5551921, 126.929247),
        },
        {
          title: "노랑통닭 홍대점",
          latlng: new kakao.maps.LatLng(37.5541424, 126.922027),
        },
      ];
